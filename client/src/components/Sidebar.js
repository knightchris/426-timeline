        ...
        <div className="sidenav">
         <Autocomplete
          ...
          /> 
            ...
            <div>
              <label htmlFor="dropdown" id="sort-dropdown-label">Sort by:</label>
              <br></br>
              ...
              <svg onClick={handleSort} id="sort-go" width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-arrow-right" fill="white" xmlns="http://www.w3.org/2000/svg">
